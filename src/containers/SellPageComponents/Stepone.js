                ...
                <div className="row justify-content-center">
                    <div className="left-fields">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" className="form-control" id="no-of-rooms" onChange={this.props.handleChange('nr_dhomash')} /></div>
                    </div>
                    <div className="right-fields">
                        <div className="form-group">
                            <label htmlFor="typeofproperty">Type of property</label>
                            <input type="text" className="form-control" id="typeofproperty" onChange={this.props.handleChange('lloji')} />
                        </div>
                        <div className="form-group">
                            <label htmlFor="surface">Floor of property</label>
                            <input type="text" className="form-control" id="surface" onChange={this.props.handleChange('kati')} />
                        </div>
                        <div className="form-group">
